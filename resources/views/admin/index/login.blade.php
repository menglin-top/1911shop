...
<head>
    ...
    <link rel="shortcut icon" href="/style/imgfavicon.png">
...
<div class="side-nav-panel-right">
    <ul id="slide-out-right" class="side-nav side-nav-panel collapsible">
        <li class="profil">
            <img src="/style/imgprofile.jpg" alt="">
            <h2>John Doe</h2>
        </li>
            ...
            <div class="container">
                <div class="content">
                    <div class="cart-1">
                        <div class="row">
                            <div class="col s5">
                                <img src="/style/img/imgcart-menu1.png" alt="">
                            </div>
                            <div class="col s7">
                    ...
                    <div class="cart-2">
                        <div class="row">
                            <div class="col s5">
                                <img src="/style/imgcart-menu2.png" alt="">
                            </div>
                            <div class="col s7">
                                <h5><a href="">Fashion Men's</a></h5>
                            </div>
